...
public class UDPServer
{
    ...
    private BlueController blueController = null;
    ...
    {
        blueController = GameObject.Find("Blue").GetComponent<BlueController>();
            ...
            if (client != null)
            {
                try
                {
                    ...
                    if (rcvMsg != string.Empty)
                    {
                        ...
                        blueController.setPosion(udpPosition.x_target*gameViewWidth, udpPosition.y_target*-gameViewHeight + gameViewHeight);
